...
export class CreateApplicationDto {
  ...
  @ApiProperty({
    description: 'API key to use to send requests to the hello sign API',
    example: ['hello-sign-api-key'],
  })
  helloSignApiKey: string;

  @ApiProperty({
    description: 'Is is required to sign the document to access the application',
    example: true,
  })
